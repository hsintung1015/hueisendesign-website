      ...
      <div className="bg-[#f5f5f5] pt-20 pb-20">
        ...
        <div className="flex items-start gap-0 mb-12">
          ...
          >
            ...
            <Link to="/services" className="text-base text-[#2d2927] tracking-wide mb-2 hover:text-[#8B4513] transition-colors cursor-pointer">
              所有服務項目
            </Link>
        ...
        {/* 主要內容區域 */}
        <div className="flex gap-12 items-center" style={{ marginLeft: '5rem', marginTop: '-1rem' }}>
          {/* 左邊圖片 */}
          <motion.div
